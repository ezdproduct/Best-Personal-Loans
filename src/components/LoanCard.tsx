...
const LoanCard: React.FC<LoanCardProps> = ({ provider }) => {
  return (
    <div className="bg-white rounded-lg shadow-xl p-4 sm:p-6 flex flex-col justify-between">
      ...
      <a href="#" className="inline-block w-full text-center bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">
